...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.sambudisp.made.mediaPlayer.mediaservice.create"
        const val ACTION_DESTROY = "com.sambudisp.made.mediaPlayer.mediaservice.destroy"
        const val PLAY = 0
        const val STOP = 1
    }
    ...
    private fun init() {
        ...
        val afd = applicationContext.resources.openRawResourceFd(R.raw.bcl)
        try {
    ...
    private fun showNotif() {
        ...
        val notificationIntent = Intent(this, MediaPlayerMainActivity::class.java)
