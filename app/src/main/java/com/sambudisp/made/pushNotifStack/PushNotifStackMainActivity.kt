package com.sambudisp.made.pushNotifStack
...
import kotlinx.android.synthetic.main.activity_push_notif_stack_main.*

class PushNotifStackMainActivity : AppCompatActivity() {

    private var idNotification = 0
    private val stackNotif = ArrayList<NotificationModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_push_notif_stack_main)
        ...
        btnSend.setOnClickListener {
            ...
            if (sender.isEmpty() || message.isEmpty()) {
                Toast.makeText(
                    this@PushNotifStackMainActivity,
                    "Data harus diisi",
                    Toast.LENGTH_SHORT
                ).show()
            } else {
                stackNotif.add(NotificationModel(idNotification, sender, message))
                sendNotif()
                idNotification++
                edtSender.setText("")
                edtMessage.setText("")
    ...
    private fun sendNotif() {
        ...
        val largeIcon = BitmapFactory.decodeResource(resources, R.drawable.ic_audiotrack_black_24dp)
        val intent = Intent(this, PushNotifStackMainActivity::class.java)
        ...
        if (idNotification < MAX_NOTIFICATION) {
            mBuilder = NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setSmallIcon(R.drawable.ic_announcement_24px)
