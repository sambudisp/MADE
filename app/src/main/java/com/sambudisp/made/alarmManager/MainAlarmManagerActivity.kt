...
import kotlinx.android.synthetic.main.activity_main_alarm_manager.*
import java.text.SimpleDateFormat
import java.util.*

class MainAlarmManagerActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
